...
struct TBDisplaySenderSettingsView: View {
    ...
    private func capabilityTitle(for capability: TBAddonCapability) -> String {
        ...
        case (.audioDriver, .italian): return "Driver audio"
        case (.audioDriver, .english): return "Audio Driver"
        case (.audioDriver, .german): return "Audiotreiber"
        case (.audioDriver, .french): return "Pilote audio"
        case (.audioDriver, .chinese): return "音频驱动"
